...
export default function FormComment() {
  return (
    <div className="form-comment flex justify-center items-center">
      <form className="md:grid md:gap-2 p-6 rounded-lg bg-neutral-300 min-h-[379px] max-h-[379px]">
        ...
        <p className="my-3 text-md text-neutral-500">
          Alamat: Jl. Masjid Nurul Ihsan, <br className="md:hidden" /> Jatiwaringin, <br className="md:block hidden" /> Pondok Gede, Kota Bekasi
        </p>
      </form>
    </div>
  );
